...
@Component({
  selector: 'app-dsa-station-summary',
  templateUrl: './dsa-station-summary.component.html',
  styleUrls: ['./dsa-station-summary.component.css']
})
export class DSAStationSummaryComponent implements OnInit {
...
LocalLockDate:string="";
  ...
  ngOnInit() {
    ...
    this.SummeryDate = new Date().toLocaleDateString();
    const dt = new Date(this.SummeryDate);     
